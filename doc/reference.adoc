...
Timestamp format accepted by _date_ command. Defaults to `%Y-%m-%dT%H:%M:%SZ` or `%Y-%m-%dT%H:%M:%S` if <<user-content-src_lib_shmate_assert-SHMATE_TIMESTAMP_LOCAL>> is a positive integer.

'''
[#user-content-src_lib_shmate_assert-SHMATE_TIMESTAMP_LOCAL,reftext='SHMATE_TIMESTAMP_LOCAL']
...
'''
[#user-content-src_lib_shmate_job-shmate_read_job_stdout,reftext='shmate_read_job_stdout']
...
'''
[#user-content-src_lib_shmate_job-shmate_read_job_stderr,reftext='shmate_read_job_stderr']
